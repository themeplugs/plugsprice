...
class PlugsPriceOne extends \Elementor\Widget_Base {

	public function get_name() {
        return "plugspriceone";
    }

	public function get_title() {
        return esc_html__( "Pricing Style 1","plugsprice");
    }
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default'=> esc_html__("/ Month","plugsprice"),
		...
		<div class="price">
			<div class="single-price">
				<div class="price-head bg-gradient">
					<span><?php echo esc_html($pl_price_currency); ?></span>
					<strong><?php echo esc_html($pl_price); ?></strong>
					<span class="duration"><?php echo esc_html($pl_price_duration); ?></span>
				</div>
